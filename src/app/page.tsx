...
export default function Page() {
    return (
        <div className="h-full bg-base-200 items-center pt-12 gap-8 flex flex-col px-12 border-l-1 border-t-1">
            ...
            <div className="w-fit flex flex-col h-136 justify-between">
